...
class NewPasswordPasswordTextField extends StatefulWidget {
  ...
  const NewPasswordPasswordTextField({
    super.key,
    this.initValue,
    required this.label,
  ...
  @override
  State<NewPasswordPasswordTextField> createState() =>
      _PasswordTextFieldState();
}

class _PasswordTextFieldState extends State<NewPasswordPasswordTextField> {
