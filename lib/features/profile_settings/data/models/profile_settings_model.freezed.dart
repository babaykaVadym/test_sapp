...
abstract class $ProfileSettingsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? fullName, @JsonKey(includeToJson: false) String? email});
}
...
class _$ProfileSettingsModelImpl implements _ProfileSettingsModel {
  const _$ProfileSettingsModelImpl(
      {this.fullName, @JsonKey(includeToJson: false) this.email});
...
// ignore: invalid_annotation_target
  ...
  @override
  String toString() {
    return 'ProfileSettingsModel(fullName: $fullName, email: $email)';
  }
