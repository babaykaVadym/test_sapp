...
class GetProfileSettingsDataUsecase {
  final ProfileSettingsRepository profileSettingsRepository;

  const GetProfileSettingsDataUsecase(this.profileSettingsRepository);

  Future<Either<ErrorModel, ProfileSettingsModel>> getPersonalProfile() async {
    return await profileSettingsRepository.getProfileSettings();
  }
}
